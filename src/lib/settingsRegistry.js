...
export const SETTINGS_ITEMS = [
  ...
  // ── General ──────────────────────────────────────────────────────────────
  {
    ...
    description: 'Launch WPDevPilot when you log into macOS',
  ...
  },
  {
    ...
    description: 'Hide to the menu bar, or quit WPDevPilot entirely',
    keywords: [
      'close',
      'window',
      'tray',
  ...
  },
  {
    ...
    section: 'general',
    title: 'Open links in',
    description: 'Use the default browser, or a browser tab inside WPDevPilot',
    keywords: [
      'links',
      'open',
      'browser',
  ...
  // ── Services ─────────────────────────────────────────────────────────────
  {
    ...
    description: 'Which services WPDevPilot brings up when it starts',
    keywords: [
      'services',
      'start',
      'launch',
  ...
  // ── DNS & HTTPS ──────────────────────────────────────────────────────────
  {
    ...
    description: 'Let WPDevPilot manage the dnsmasq resolver without a password prompt',
    keywords: [
      'sudo',
      'sudoers',
      'password',
  ...
  // ── Dependencies / About ─────────────────────────────────────────────────
  {
    ...
    title: 'Dependencies',
    description: 'Homebrew packages WPDevPilot needs to run services',
    keywords: [
      'dependencies',
      'homebrew',
      'brew',
